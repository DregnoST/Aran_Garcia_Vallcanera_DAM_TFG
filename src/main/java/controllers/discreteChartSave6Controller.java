...
public class discreteChartSave6Controller {
	...
	public void initialize() {
		...
		Handler.probXDamageSave6.addListener((ListChangeListener.Change<? extends ProbabilityXDamageDataModel> change) -> {
			updateBarLineChart();
		});
	...
	private void updateBarLineChart() {
		...
		for (ProbabilityXDamageDataModel item : Handler.probXDamageSave6) {
