...
public class cumulativeChartSave6Controller {
	...
	public void initialize() {
		...
		Handler.probXDamageOrLessSave6.addListener((ListChangeListener.Change<? extends ProbabilityXDamageDataModel> change) -> {
			updateBarLineChart();
		});
	...
	private void updateBarLineChart() {
		...
		for (ProbabilityXDamageDataModel item : Handler.probXDamageOrLessSave6) {
