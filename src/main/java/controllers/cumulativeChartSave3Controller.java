...
public class cumulativeChartSave3Controller {
	...
	public void initialize() {
		...
		Handler.probXDamageOrLessSave3.addListener((ListChangeListener.Change<? extends ProbabilityXDamageDataModel> change) -> {
			updateBarLineChart();
		});
	...
	private void updateBarLineChart() {
		...
		for (ProbabilityXDamageDataModel item : Handler.probXDamageOrLessSave3) {
