...
public class discreteChartSave2Controller {
	...
	public void initialize() {
		...
		Handler.probXDamageSave2.addListener((ListChangeListener.Change<? extends ProbabilityXDamageDataModel> change) -> {
			updateBarLineChart();
		});
	...
	private void updateBarLineChart() {
		...
		for (ProbabilityXDamageDataModel item : Handler.probXDamageSave2) {
