...
public class discreteChartSave5Controller {
	...
	public void initialize() {
		...
		Handler.probXDamageSave5.addListener((ListChangeListener.Change<? extends ProbabilityXDamageDataModel> change) -> {
			updateBarLineChart();
		});
	...
	private void updateBarLineChart() {
		...
		for (ProbabilityXDamageDataModel item : Handler.probXDamageSave5) {
