...
public class cumulativeChartSave7Controller {
	...
	public void initialize() {
		...
		Handler.probXDamageOrLessSave7.addListener((ListChangeListener.Change<? extends ProbabilityXDamageDataModel> change) -> {
			updateBarLineChart();
		});
	...
	private void updateBarLineChart() {
		...
		for (ProbabilityXDamageDataModel item : Handler.probXDamageOrLessSave7) {
