...
public class discreteChartSave3Controller {
	...
	public void initialize() {
		...
		Handler.probXDamageSave3.addListener((ListChangeListener.Change<? extends ProbabilityXDamageDataModel> change) -> {
			updateBarLineChart();
		});
	...
	private void updateBarLineChart() {
		...
		for (ProbabilityXDamageDataModel item : Handler.probXDamageSave3) {
