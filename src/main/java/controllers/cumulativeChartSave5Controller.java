...
public class cumulativeChartSave5Controller {
	...
	public void initialize() {
		...
		Handler.probXDamageOrLessSave5.addListener((ListChangeListener.Change<? extends ProbabilityXDamageDataModel> change) -> {
			updateBarLineChart();
		});
	...
	private void updateBarLineChart() {
		...
		for (ProbabilityXDamageDataModel item : Handler.probXDamageOrLessSave5) {
